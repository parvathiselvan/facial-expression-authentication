...
This script deletes all records from the users and facial_data tables.
"""
...
def clear_database():
    ...
    try:
        ...
        if 'facial_data' in table_names:
            ...
            print(f"Deleted {cursor.rowcount} records from facial_data table")
        else:
        ...
        if 'users' in table_names:
            ...
            print(f"Deleted {cursor.rowcount} records from users table")
        else:
